...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        ...
        public double mmPerTick = 1 / GoBildaPinpointDriver.goBILDA_4_BAR_POD; // replace mmPerTick (divide circumference of odo. wheels in mm by the number of ticks per revolution)
